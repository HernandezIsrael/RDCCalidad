...
namespace Model
{
    ...
    public partial class DocumentosREjecucion
    {
        public int IdDocumentoREjecucion { get; set; }
        public int IdREjecucion { get; set; }
        public string Nombre { get; set; }
        public string Nombre_Virtual { get; set; }
        public Nullable<int> IdTipoREjecucion { get; set; }
